...
public class BluetoothChatService {
    ...
    private static final UUID MY_UUID = UUID.fromString("2d64189d-5a2c-4511-a074-77f199fd0834");
...
//        if (mConnectedThread != null) {mConnectedThread.cancel(); mConnectedThread = null;}
    ...
    public synchronized void connectedClient(BluetoothSocket socket, BluetoothDevice device) {
        ...
        mConnectedClientThread = new ConnectedThread(socket, SERVER_ID,device.getName()); // TODO -1 is the server that we connected, socket also server's socket
...
//        if (mAcceptThread != null) {mAcceptThread.cancel(); mAcceptThread = null;}
        ...
        if (connectedDevices == 1) {
            mConnectedThread1 = new ConnectedThread(socket, connectedDevices,device.getName());
            ...
            mConnectedThread2 = new ConnectedThread(socket, connectedDevices,device.getName());
            ...
            mConnectedThread3 = new ConnectedThread(socket, connectedDevices,device.getName());
    ...
    private void connectionLost(String deviceName) {
        ...
        // Send a failure message back to the Activity
        Message message = mHandler.obtainMessage(BluetoothChat.MESSAGE_DISCONNECT);
        Bundle bund = new Bundle();
        bund.putString(BluetoothChat.DEVICE_NAME, deviceName);
        ...
        Message msg = mHandler.obtainMessage(BluetoothChat.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(BluetoothChat.TOAST, "Device connection was lost with "+deviceName);
        msg.setData(bundle);
        mHandler.sendMessage(msg);
        stop();
